...
export const fetchRegistration = async (nctId) => {
...
export const fetchRegistrationFs = (nctId) => {
  const path = `./ctg-studies.json/${nctId}.json`;
  log(`Reading registration from file ${path}`);
