...
const INPUT_FILE = `./out/batch/gpt_job_query/input/${FILE_NAME}.jsonl`;
const OUTPUT_FILE = `./out/batch/gpt_job_query/metadata/${FILE_NAME}.json`;
...
(async () => {
  console.log("WARNING: UPLOADING BATCH JOB - QUERIES");
